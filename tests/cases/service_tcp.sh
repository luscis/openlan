...
show_description() {
  echo "verify ceci service tcp forwarding and restart"
}

show_topology_summary() {
  cat <<'EOF'
client wget on sw1 | sw1 Ceci TCP service -- output --> sw2 backend 192.56.0.2:18083
EOF
}
...
#   sw1=100.100.0.241 (ceci service), sw2=100.100.0.242 (service backends).
