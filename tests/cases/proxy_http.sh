...
EOF
  ...
  assert_cmd docker exec $name openlan network --name example output add --remote 172.252.0.241 --protocol tcp --secret t1@example:123456 --crypt aes-128:ea64d5b0c96c
